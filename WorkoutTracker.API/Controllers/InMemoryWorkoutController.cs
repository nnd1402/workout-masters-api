...
namespace WorkoutTracker.API.Controllers
{
    ...
    [ApiController]
    public class InMemoryWorkoutController : ControllerBase
    {
        readonly IWorkoutRepository _workoutRepository;
        public InMemoryWorkoutController(IWorkoutRepository workoutRepository)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Workout>> CreateEmployee(Workout workout)
        {
            try
            {
                if (workout == null)
